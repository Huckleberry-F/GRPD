...
for k = 1:size(F_path, 1)
    ...
    if hasDamage && damage >= Dc
        ...
        if J2 > 1e-16
            f = J2 - SY;
            if f > 1e-8
                % 调用局部 Newton-Raphson 求解器获取增量 dg
                ...
                if hasDamage && realEqNew > p_D
                    ...
                    % 调用局部 Newton-Raphson 求解器获取损伤度 W
