...
```powershell
python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/check_cmake_sources.py .
python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/list_registry_macros.py .
python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/check_field_references.py .
python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/inspect_writer_variables.py .
python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/validate_pd_yaml_basic.py Examples\Sphere\PD.yaml
```
