...
- 详细物理与约定说明：[point-integration-validation.md](file:///d:/Project_C++/GRPD/.agents/skills/superCAE/skills/constitutive-math-reviewer/references/point-integration-validation.md)
