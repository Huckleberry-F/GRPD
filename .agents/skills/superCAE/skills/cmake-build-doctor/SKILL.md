...
2. 运行 `python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/check_cmake_sources.py .`。
3. 如涉及注册宏，运行 `python .agents/skills/superCAE/skills/grpd-cae-toolkit/scripts/list_registry_macros.py .`。
