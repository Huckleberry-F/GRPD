...
3. 如验证 PD.yaml，运行 `python .gemini/skills/grpd-cae-toolkit/scripts/validate_pd_yaml_basic.py <PD.yaml>`。
4. 如验证输出字段，运行 `python .gemini/skills/grpd-cae-toolkit/scripts/inspect_writer_variables.py . --yaml <PD.yaml>`。
